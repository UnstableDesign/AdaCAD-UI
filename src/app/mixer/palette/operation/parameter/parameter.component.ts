...
import { AnalyzedImage } from 'adacad-drafting-lib';
import { BoolParam, CodeParam, FileParam, NotationTypeParam, NumParam, SelectParam, StringParam } from 'adacad-drafting-lib/operations';
