import { Component, ComponentFactoryResolver, EventEmitter, HostListener, inject, OnInit, Output, ViewChild, ViewContainerRef, ViewRef } from '@angular/core';
...
import { Bounds, DraftNode, DraftNodeProxy, NodeComponentProxy, Note, OpNode, Point } from '../../core/model/datatypes';
